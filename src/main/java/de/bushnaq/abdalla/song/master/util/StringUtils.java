...
public class StringUtils {
	/**
	 * Returns the index of the first whitespace character or '-' in <var>line</var> that is at or after <var>start</var>. Returns -1 if no such character is found.
	 *
	 * @param line  a string
	...
	/**
	 * Returns the index of the first whitespace character or '-' in <var>line</var> that is at or before <var>start</var>. Returns -1 if no such character is found.
	 *
	 * @param line  a string
	 * @param start where to star looking
	 */
	...
	/**
	 * Returns an array of strings, one for each line in the string after it has been wrapped to fit lines of <var>maxWidth</var>. Lines end with any of cr, lf, or cr lf. A line ending at the end of the string will not
	...
	public static List<String> wrap(String str, FontMetrics fm, int maxWidth) {
		...
		// the space is enough for at least every single character
		for (int i = 0; i < str.length(); i++) {
			if (fm.stringWidth(str.substring(i, i)) > maxWidth) {
				return null;
			}
		}
		...
		do {
			for (int i = 0; i < str.length(); i++) {
				if (fm.stringWidth(str.substring(0, i)) > maxWidth) {
